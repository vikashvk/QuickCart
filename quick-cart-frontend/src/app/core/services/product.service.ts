...
export class ProductService {
  ...
  private fallbackProducts(): Product[] {
    return [
      ...
      { id: 'p4', name: 'Priority Support Slot', description: '30 minutes of guaranteed support queue skip.', category: 'Support', priceSeconds: 1800, imageUrl: 'https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=400', inStock: false },
      { id: 'p5', name: 'Mentor Match', description: '2 hours paired with a senior engineer mentor.', category: 'Career', priceSeconds: 7200, imageUrl: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=400', inStock: true },
